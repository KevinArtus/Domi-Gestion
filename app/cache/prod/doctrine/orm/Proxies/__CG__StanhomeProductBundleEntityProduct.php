...
namespace Proxies\__CG__\Stanhome\ProductBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Product extends \Stanhome\ProductBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'reference', 'libelle', 'price', 'category', '' . "\0" . 'Stanhome\\ProductBundle\\Entity\\Product' . "\0" . 'shoppingProducts');
        }
