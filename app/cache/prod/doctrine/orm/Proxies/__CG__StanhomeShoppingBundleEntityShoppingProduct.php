 ...
 */
class ShoppingProduct extends \Stanhome\ShoppingBundle\Entity\ShoppingProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Stanhome\\ShoppingBundle\\Entity\\ShoppingProduct' . "\0" . 'shopping', '' . "\0" . 'Stanhome\\ShoppingBundle\\Entity\\ShoppingProduct' . "\0" . 'product', '' . "\0" . 'Stanhome\\ShoppingBundle\\Entity\\ShoppingProduct' . "\0" . 'quantity');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ShoppingProduct $proxy) {
