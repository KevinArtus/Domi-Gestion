...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fime.portal.search.search_providers' => 'getFime_Portal_Search_SearchProvidersService',
            'fime.rh.search.user_search' => 'getFime_Rh_Search_UserSearchService',
            ...
            'fos_elastica.finder.fime.customers' => 'getFosElastica_Finder_Fime_CustomersService',
            'fos_elastica.index.fime' => 'getFosElastica_Index_FimeService',
            'fos_elastica.index.fime.customers' => 'getFosElastica_Index_Fime_CustomersService',
            'fos_elastica.index.fime.customers.serializer.callback' => 'getFosElastica_Index_Fime_Customers_Serializer_CallbackService',
            ...
            'fos_elastica.object_persister.fime.customers' => 'getFosElastica_ObjectPersister_Fime_CustomersService',
            ...
            'fos_elastica.provider.fime.customers' => 'getFosElastica_Provider_Fime_CustomersService',
            ...
            'stanhome.controller.meeting' => 'getStanhome_Controller_MeetingService',
            'stanhome.repository.meeting' => 'getStanhome_Repository_MeetingService',
            'stanhome.rh.form.user_selector' => 'getStanhome_Rh_Form_UserSelectorService',
        ...
        $this->aliases = array(
            ...
            'fos_elastica.index' => 'fos_elastica.index.fime',
            ...
            'stanhome.manager.meeting' => 'doctrine.orm.default_entity_manager',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.fime.customers'), $this->get('fos_elastica.indexable'), array('identifier' => 'id', 'indexName' => 'fime', 'typeName' => 'Customers'), NULL));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'stanhome', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Stanhome/RhBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Stanhome/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Stanhome/MeetingBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Stanhome\\RhBundle\\Entity');
        $c->addDriver($b, 'Stanhome\\UserBundle\\Entity');
        $c->addDriver($b, 'Stanhome\\MeetingBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('StanhomeRhBundle' => 'Stanhome\\RhBundle\\Entity', 'StanhomeUserBundle' => 'Stanhome\\UserBundle\\Entity', 'StanhomeMeetingBundle' => 'Stanhome\\MeetingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d17254f29146b8f79f363295cdb1c9d775c1f770c0b3d77fb74523de6481e95c');
    ...
    /**
     * Gets the 'fime.portal.search.search_providers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Stanhome\PortalBundle\Search\SearchProviders A Stanhome\PortalBundle\Search\SearchProviders instance.
     */
    protected function getFime_Portal_Search_SearchProvidersService()
    {
        $this->services['fime.portal.search.search_providers'] = $instance = new \Stanhome\PortalBundle\Search\SearchProviders();

        $instance->addProvider($this->get('fime.rh.search.user_search'), 'customer');

        return $instance;
    }

    /**
     * Gets the 'fime.rh.search.user_search' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Stanhome\PortalBundle\Search\SearchProvider A Stanhome\PortalBundle\Search\SearchProvider instance.
     */
    protected function getFime_Rh_Search_UserSearchService()
    {
        return $this->services['fime.rh.search.user_search'] = new \Stanhome\PortalBundle\Search\SearchProvider($this->get('fos_elastica.manager.orm'), array(0 => 'nom', 1 => 'prenom'), 'StanhomeRhBundle:Customer', 'stanhome_rh_customer_show', 'StanhomeRhBundle.customers.search_header', 'glyphicon-user violetFime');
    }
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('fime' => array('elasticsearch_name' => 'fime', 'reference' => $this->get('fos_elastica.index.fime'), 'name' => 'fime', 'settings' => array('index' => array('analysis' => array('analyzer' => array('custom_search_analyzer' => array('type' => 'custom', 'tokenizer' => 'standard', 'filter' => array(0 => 'standard', 1 => 'lowercase', 2 => 'asciifolding')), 'custom_index_analyzer' => array('type' => 'custom', 'tokenizer' => 'edgeNGram', 'filter' => array(0 => 'standard', 1 => 'lowercase', 2 => 'asciifolding'))), 'tokenizer' => array('edgeNGram' => array('type' => 'edgeNGram', 'min_gram' => 1, 'max_gram' => 20))))), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('Customers' => array('name' => 'Customers', 'mapping' => array('dynamic_templates' => array(), 'properties' => array('nom' => array('search_analyzer' => 'custom_search_analyzer', 'index_analyzer' => 'custom_index_analyzer', 'type' => 'string', 'boost' => 1), 'prenom' => array('search_analyzer' => 'custom_search_analyzer', 'index_analyzer' => 'custom_index_analyzer', 'type' => 'string', 'boost' => 1))), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'Stanhome\\RhBundle\\Entity\\Customer', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder'), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'finder' => array(), 'identifier' => 'id', 'elastica_to_model_transformer' => array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array()), 'serializer' => array('groups' => array()), 'index_analyzer' => NULL, 'search_analyzer' => NULL, 'date_detection' => NULL, 'dynamic_date_formats' => array(), 'numeric_detection' => NULL))))))));
    }
    ...
    /**
     * Gets the 'fos_elastica.finder.fime.customers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Finder_Fime_CustomersService()
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'Stanhome\\RhBundle\\Entity\\Customer', array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder', 'identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.finder.fime.customers'] = new \FOS\ElasticaBundle\Finder\TransformedFinder($this->get('fos_elastica.index.fime.customers'), $a);
    }

    /**
     * Gets the 'fos_elastica.index.fime' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_FimeService()
    {
        return $this->services['fos_elastica.index.fime'] = $this->get('fos_elastica.client.default')->getIndex('fime');
    }

    /**
     * Gets the 'fos_elastica.index.fime.customers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Fime_CustomersService()
    {
        $this->services['fos_elastica.index.fime.customers'] = $instance = $this->get('fos_elastica.index.fime')->getType('Customers');

        $instance->setSerializer(array(0 => $this->get('fos_elastica.index.fime.customers.serializer.callback'), 1 => 'serialize'));
    ...
    {
        $a = $this->get('fos_elastica.index.fime');

        return $this->services['fos_elastica.index_manager'] = new \FOS\ElasticaBundle\Index\IndexManager(array('fime' => $a), $a);
    }
    ...
    protected function getFosElastica_Manager_OrmService()
    {
        ...
        $instance->addEntity('Stanhome\\RhBundle\\Entity\\Customer', $this->get('fos_elastica.finder.fime.customers'));
    ...
    /**
     * Gets the 'fos_elastica.object_persister.fime.customers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_ObjectPersister_Fime_CustomersService()
    {
        $a = new \FOS\ElasticaBundle\Transformer\ModelToElasticaIdentifierTransformer(array('identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.object_persister.fime.customers'] = new \FOS\ElasticaBundle\Persister\ObjectSerializerPersister($this->get('fos_elastica.index.fime.customers'), $a, 'Stanhome\\RhBundle\\Entity\\Customer', array(0 => $this->get('fos_elastica.index.fime.customers.serializer.callback'), 1 => 'serialize'));
    }
    ...
    /**
     * Gets the 'fos_elastica.provider.fime.customers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Provider_Fime_CustomersService()
    {
        return $this->services['fos_elastica.provider.fime.customers'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.fime.customers'), $this->get('fos_elastica.indexable'), 'Stanhome\\RhBundle\\Entity\\Customer', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'fime', 'typeName' => 'Customers'), $this->get('doctrine'), $this->get('fos_elastica.slice_fetcher.orm'));
    }
    ...
    protected function getFosElastica_ProviderRegistryService()
    {
        ...
        $instance->addProvider('fime', 'Customers', 'fos_elastica.provider.fime.customers');
    ...
    /**
     * Gets the 'fos_elastica.serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Stanhome\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Stanhome\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Stanhome\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Stanhome\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Stanhome\\UserBundle\\Entity\\User');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Doctrine/Bundle/FixturesBundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'Sylius\\Bundle\\ResourceBundle' => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/serializer'), 'FOS\\ElasticaBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/elastica-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Stanhome\\RhBundle' => ($this->targetDirs[3].'/src/Stanhome/RhBundle/Resources/config/serializer'), 'Stanhome\\UserBundle' => ($this->targetDirs[3].'/src/Stanhome/UserBundle/Resources/config/serializer'), 'Stanhome\\PortalBundle' => ($this->targetDirs[3].'/src/Stanhome/PortalBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/config/serializer'), 'Stanhome\\MeetingBundle' => ($this->targetDirs[3].'/src/Stanhome/MeetingBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Stanhome\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '9d7b9c0f4791d407a63423a18f31feb5592aa7a3', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, 'fos_user_security_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    /**
     * Gets the 'stanhome.controller.meeting' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Stanhome\MeetingBundle\Controller\MeetingController A Stanhome\MeetingBundle\Controller\MeetingController instance.
     */
    protected function getStanhome_Controller_MeetingService()
    {
        $this->services['stanhome.controller.meeting'] = $instance = new \Stanhome\MeetingBundle\Controller\MeetingController($this->get('sylius.controller.configuration_factory')->createConfiguration('stanhome', 'meeting', 'StanhomeMeetingBundle:Meeting'));
    ...
    /**
     * Gets the 'stanhome.repository.meeting' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getStanhome_Repository_MeetingService()
    {
        return $this->services['stanhome.repository.meeting'] = new \Sylius\Bundle\ResourceBundle\Doctrine\ORM\EntityRepository($this->get('doctrine.orm.default_entity_manager'), $this->get('doctrine.orm.default_entity_manager')->getClassMetadata('Stanhome\\MeetingBundle\\Entity\\Meeting'));
    }

    /**
     * Gets the 'stanhome.rh.form.user_selector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Stanhome\RhBundle\Form\UserSelectorType A Stanhome\RhBundle\Form\UserSelectorType instance.
     */
    protected function getStanhome_Rh_Form_UserSelectorService()
    {
        return $this->services['stanhome.rh.form.user_selector'] = new \Stanhome\RhBundle\Form\UserSelectorType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['sylius.event_subscriber.load_odm_metadata'] = new \Sylius\Bundle\ResourceBundle\EventListener\LoadODMMetadataSubscriber(array('stanhome.meeting' => array('driver' => 'doctrine/orm', 'templates' => 'StanhomeMeetingBundle:Meeting', 'classes' => array('model' => 'Stanhome\\MeetingBundle\\Entity\\Meeting', 'controller' => 'Stanhome\\MeetingBundle\\Controller\\MeetingController'), 'object_manager' => 'default')));
    }
    ...
    {
        return $this->services['sylius.event_subscriber.load_orm_metadata'] = new \Sylius\Bundle\ResourceBundle\EventListener\LoadORMMetadataSubscriber(array('stanhome.meeting' => array('driver' => 'doctrine/orm', 'templates' => 'StanhomeMeetingBundle:Meeting', 'classes' => array('model' => 'Stanhome\\MeetingBundle\\Entity\\Meeting', 'controller' => 'Stanhome\\MeetingBundle\\Controller\\MeetingController'), 'object_manager' => 'default')));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.it.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.it.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.sv.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.et.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.et.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.tr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ru.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ja.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ja.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.uk.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.uk.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.fi.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.da.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.da.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.cs.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ca.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ca.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.af.yml'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.af.yml')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.hr.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.hr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.de.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.de.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.hu.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.el.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.el.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ar.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.vi.yml'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.sr_Cyrl.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.nl.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.nl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ro.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ro.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.es.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.es.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.he.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.he.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.id.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.pt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.sk.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.sk.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.en.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.en.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.th.yml'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.fr.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.fr.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 7 => ($this->targetDirs[3].'/src/Stanhome/RhBundle/Resources/translations/messages.fr.yml'), 8 => ($this->targetDirs[3].'/src/Stanhome/UserBundle/Resources/translations/messages.fr.yml'), 9 => ($this->targetDirs[3].'/src/Stanhome/PortalBundle/Resources/translations/messages.fr.yml'), 10 => ($this->targetDirs[3].'/src/Stanhome/MeetingBundle/Resources/translations/messages.fr.yml'), 11 => ($this->targetDirs[2].'/Resources/translations/base.fr.yml')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.sl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.no.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.no.yml')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.bg.yml'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.bg.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.pl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf')), 'ko' => array(0 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ko.yml'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ko.yml')), 'be' => array(0 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.be.yml'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.be.yml')), 'sr' => array(0 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.sr.yml'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.sr.yml')), 'ms' => array(0 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.ms.yml'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.ms.yml')), 'zh' => array(0 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/messages.zh.yml'), 1 => ($this->targetDirs[3].'/vendor/sylius/resource-bundle/Resources/translations/flashes.zh.yml')))), array());
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Stanhome/RhBundle/Resources/views'), 'StanhomeRh');
        $instance->addPath(($this->targetDirs[3].'/src/Stanhome/UserBundle/Resources/views'), 'StanhomeUser');
        $instance->addPath(($this->targetDirs[3].'/src/Stanhome/PortalBundle/Resources/views'), 'StanhomePortal');
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'/src/Stanhome/MeetingBundle/Resources/views'), 'StanhomeMeeting');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9d7b9c0f4791d407a63423a18f31feb5592aa7a3');
    }
    ...
    /**
     * Gets the 'fos_elastica.index.fime.customers.serializer.callback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Fime_Customers_Serializer_CallbackService()
    {
        $this->services['fos_elastica.index.fime.customers.serializer.callback'] = $instance = new \FOS\ElasticaBundle\Serializer\Callback();
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'StanhomeRhBundle' => 'Stanhome\\RhBundle\\StanhomeRhBundle',
                'StanhomeUserBundle' => 'Stanhome\\UserBundle\\StanhomeUserBundle',
                'StanhomePortalBundle' => 'Stanhome\\PortalBundle\\StanhomePortalBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'StanhomeMeetingBundle' => 'Stanhome\\MeetingBundle\\StanhomeMeetingBundle',
            ...
            'locale' => 'fr',
            'secret' => '9d7b9c0f4791d407a63423a18f31feb5592aa7a3',
            'elastica_host' => 'localhost',
            'elastica_port' => 9200,
            'database_path' => NULL,
            'fime.portal.search.search_providers.class' => 'Stanhome\\PortalBundle\\Search\\SearchProviders',
            ...
            'kernel.secret' => '9d7b9c0f4791d407a63423a18f31feb5592aa7a3',
            ...
            'sylius.config.classes' => array(
                'stanhome.meeting' => array(
                    'driver' => 'doctrine/orm',
                    'templates' => 'StanhomeMeetingBundle:Meeting',
                    'classes' => array(
                        'model' => 'Stanhome\\MeetingBundle\\Entity\\Meeting',
                        'controller' => 'Stanhome\\MeetingBundle\\Controller\\MeetingController',
                    ),
            ...
            'fos_user.model.user.class' => 'Stanhome\\UserBundle\\Entity\\User',
            ...
            'searchprovider.class' => 'Stanhome\\PortalBundle\\Search\\SearchProvider',
            'fime.rh.security.user_provider.class' => 'Stanhome\\RhBundle\\Security\\CustomerProvider',
            'stanhome.rh.form.user_selector.class' => 'Stanhome\\RhBundle\\Form\\UserSelectorType',
